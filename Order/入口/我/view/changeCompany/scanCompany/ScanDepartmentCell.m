...
- (void)initSubviews{
    ...
    _themeLabel = [self creatLabelWithFrame:CGRectZero textAlignment:NSTextAlignmentLeft font:[UIFont boldSystemFontOfSize:14.0] textColor:color text:nil];
    [_scrollView addSubview:_themeLabel];
    /** 详细Label*/
    _detailLabel = [self creatLabelWithFrame:CGRectZero textAlignment:NSTextAlignmentLeft font:[UIFont systemFontOfSize:10.0f] textColor:color text:nil];
