...
@interface WQRegisPersonController ()<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate,SexViewDelegate,UITextViewDelegate,SelectedDepartPositionDelegate,UITextFieldDelegate>
@property(nonatomic,strong)AFHTTPSessionManager *manager;
@property (weak, nonatomic) IBOutlet UIView *companyInfo;
/** tableview*/
...
@implementation WQRegisPersonController
...
- (void)viewDidLoad {
    ...
    _data = @[@"用户名:",@"密码:",@"确认密码:",@"邮箱:",@"邮箱验证码:",@"电话:",@"电话验证码:",@"姓名:",@"座机:",@"性别:",@"部门:",@"职位:",@"工号:",@"家庭住址:",@"个人描述:"];
    //创建scrollview
    _scrollView = [[UIScrollView alloc]initWithFrame:CGRectMake(0, 64+101,KScreenWidth, _data.count *50 +250)];
    _scrollView.contentSize = CGSizeMake(KScreenWidth, _data.count *50 +600);
...
-(void)memberActivationCode{
    ...
    @try {
        ...
        useb = [[UserBean alloc]initWithszUsername:userNamelabel.text szPassword:password1.text objDeviceID:D];
